# Generated by Django 5.2.5 on 2025-09-14 02:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='library',
            name='books',
            field=models.ManyToManyField(through='relationship_app.Library_books', to='relationship_app.book'),
        ),
        migrations.CreateModel(
            name='Member',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('libraries', models.ManyToManyField(related_name='members', to='relationship_app.library')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
