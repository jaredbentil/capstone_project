...
SECRET_KEY = 'django-insecure-v!s^z116c4kx0ybvj!23%n6+f64hxk6!2kdrx3v4&=zhlr^qk-'
...
#DRF to use Token Authentication globally
REST_FRAMEWORK = {
...
# Email backend configuration (for development, using console backend)
